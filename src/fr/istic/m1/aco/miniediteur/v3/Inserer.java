...
public class Inserer implements CommandeEnregistrable {
	...
	/**
	 * @brief Constructeur affectant un Moteur, une IHM, un Enregistreur et un GestionnaireDefaireRefaire qui seront utilisés par l'insertion
	 ...
	 * @param gest le GestionnaireDefaireRefaire qui sera utilisé pour "Undo-Redo" les commandes
	 */
